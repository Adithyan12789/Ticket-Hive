...
class TheaterController {
    authTheaterOwner = asyncHandler(async (req: Request, res: Response): Promise<void> => {
        ...
        try {
            const theater = await TheaterOwnerService.authTheaterOwnerService(email, password);
    ...
    googleLoginTheaterOwner = asyncHandler(async (req: Request, res: Response): Promise<void> => {
        ...
        try {
            ...
            if (theaterOwner) {
                TheaterTokenService.generateTheaterToken(res, theaterOwner._id.toString());
                res.status(200).json({
                    success: true,
                    data: {
    ...
    registerTheaterOwner = asyncHandler(async (req: Request, res: Response): Promise<void> => {
        ...
        try {
            const theater = await TheaterOwnerService.registerTheaterOwnerService(name, email, password, phone);
    ...
    verifyTheaterOwnerOTP = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    resendTheaterOwnerOtp = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    forgotTheaterOwnerPassword = asyncHandler(async (req: Request, res: Response): Promise<void> => {
        const { email } = req.body;
        ...
        try {
            const resetToken = await TheaterOwnerService.forgotTheaterOwnerPasswordService(email);
    ...
    resetTheaterOwnerPassword = asyncHandler(async (req: Request, res: Response): Promise<void> => {
        ...
        try {
            await TheaterOwnerService.resetTheaterOwnerPasswordService(resetToken, password);
    ...
    getTheaterProfile = asyncHandler(async (req: CustomRequest, res: Response): Promise<void> => {
        if (!req.theaterOwner) {
      ...
      updateTheaterProfile = asyncHandler(async (req: CustomRequest, res: Response): Promise<void> => {
        if (!req.theaterOwner) {
          res.status(401).json({ message: "Unauthorized" });
          return;
        }
        ...
        try {
          ...
          const updatedTheaterOwner = await TheaterOwnerService.updateTheaterOwnerProfileService(
