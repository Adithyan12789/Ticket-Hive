...
router.get('/reviews/:movieId',AuthMiddleware, reviewControllerr.getReviewsController);
router.get('/allReviews',AuthMiddleware, reviewControllerr.getAllReviewsController);
router.post('/reviews',AuthMiddleware, reviewControllerr.addReviewsController);

router.get('/movie-theaters/:movieTitle', AuthMiddleware, theaterControllerr.getTheatersByMovieTitle);

router.get('/screen/:screenId', AuthMiddleware, screenControllerr.getScreensById);

router.post('/update-availability', AuthMiddleware, screenControllerr.updateSeatAvailability);

router.get('/offers/:theaterId', AuthMiddleware, userControllerr.getOffersByTheaterId);
